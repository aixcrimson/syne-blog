      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <ul class="space-y-2">
            ...
            <li v-if="appStore.userInfo.twitter" class="flex items-center space-x-2">
              <el-icon><Link /></el-icon>
              <a :href="appStore.userInfo.twitter" target="_blank" class="text-sm hover:text-primary-400">
                Twitter
              </a>
            </li>
          </ul>
