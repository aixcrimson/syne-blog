  ...
  <div class="about py-12 bg-transparent">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="glass-card rounded-lg shadow-sm overflow-hidden mb-8">
        <div
          class="bg-gradient-to-r from-primary-600 to-primary-800 h-32"
        ></div>
        <div class="px-8 pb-8">
      ...
      <div class="glass-card rounded-lg shadow-sm p-8 mb-8">
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
          <div
            ...
            :key="skill.name"
            class="skill-card p-4 border border-gray-200 dark:border-gray-700 rounded-lg hover:border-primary-500 transition-colors"
          >
